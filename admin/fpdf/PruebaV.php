...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(30, 10, utf8_decode('GMAIL'), 1, 0, 'C', 1);
      $this->Cell(50, 10, utf8_decode('CONTRASEÑA'), 1, 0, 'C', 1);
   }
...
$pdf->Cell(30, 10, utf8_decode("GMAIL"), 1, 0, 'C', 0);
$pdf->Cell(50, 10, utf8_decode("CONTRASEÑA"), 1, 0, 'C', 0);
