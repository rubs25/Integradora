...
<div class="container p-4">
  <div class="row">
    <div class="col-md-4 mx-auto">
      ...
      <form action="addd.php?id=<?php echo $_GET['id']; ?>" method="POST">
      ...
      <input type="text" id="codigo-barras" name="codigo-barras" value="<?php echo $codigo; ?>">

      <label for="precio-compra">Precio Compra:</label>
      <input type="number" id="precio-compra" name="precio-compra" min="0" step="0.01" value="<?php echo $precioc; ?>">

      <label for="precio-venta">Precio Venta:</label>
      <input type="number" id="precio-venta" name="precio-venta" min="0" step="0.01" value="<?php echo $preciov; ?>">
      ...
      <input type="number" id="cantidad-disponible" name="cantidad-disponible" min="0" value="<?php echo $cantd; ?>">

      <label for="costo-envio">Costo de Envío:</label>
      <input type="number" id="costo-envio" name="costo-envio" min="0" step="0.01" value="<?php echo $costo; ?>">


        <input type="submit" name="addd" class="btn btn-primary"></input>
      </form>
      </div>
    </div>
  </div>
